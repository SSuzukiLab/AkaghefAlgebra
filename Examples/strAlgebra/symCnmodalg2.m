classdef(InferiorClasses=?sym) symCnmodalg2<symp
...
properties(Constant,Hidden)
    ...
    methods (Static)
        function v=getGenerator(l)
            v=rowfun(@(x)symCnmodalg2(1,x),table(eye(2*l)));
            v=dictionary([-l:-1,1:l]',v.Var1);
        end
    end
    methods
        function obj = symCnmodalg2(varargin)
        ...
        function ret=mtimes(i1,i2)
            ret=prodeval4(symCnmodalg2(i1|i2))+0;
            ret.base=i1.base;
        end
