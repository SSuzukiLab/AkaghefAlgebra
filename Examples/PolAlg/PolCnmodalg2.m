classdef(InferiorClasses=?Pol) PolCnmodalg2<PolAlg
...
properties(Constant,Hidden)
    ...
    methods (Static)
        function v=getGenerator(l)
            v=rowfun(@(x)PolCnmodalg2(1,x),table(eye(2*l)));
            v=dictionary([-l:-1,1:l]',v.Var1);
        end
    end
    methods
        function obj = PolCnmodalg2(varargin)
        ...
        function ret=mtimes(i1,i2)
            ret=prodeval4(PolCnmodalg2(i1|i2))+0;
            ret.base=i1.base;
        end
